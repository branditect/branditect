...
export const OUTSTANDING: [string, number][] = [
  ...
  ["components/numbers/calc-shell.tsx", 7],
  ["components/numbers/guardrails-panel.tsx", 14],
  ["components/onboarding-strip.tsx", 4],
  ["components/products/image-picker.tsx", 12],
  ["components/products/media-tab.tsx", 13],
  ["components/products/pricing-tab.tsx", 18],
  ["components/products/product-drawer.tsx", 45],
  ["components/products/product-picker.tsx", 11],
  ["components/products/remove-product.tsx", 3],
  ["components/products/specs-editor.tsx", 7],
  ...
  ["components/visual-identity/uploads.tsx", 20],
  ["components/welcome-modal.tsx", 26],
