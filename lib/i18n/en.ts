...
export const en = {
  ...
  "files.upload.noBrand": "No brand is selected, so there is nowhere to store these files. Reload the page, and if that does not help, finish brand setup first.",
  "files.upload.signedOut": "Your session has ended, so nothing was uploaded. Sign in again and try once more — your picked files are still here.",
  "files.upload.notYourBrand": "this brand's files belong to another account. Sign in with the account that owns the brand.",
