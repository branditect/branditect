...
export const fi: Record<StringKey, string> = {
  ...
  "channels.q1": "Mitkä kaksi alustaa valitset?",
  "channels.q1Why":
    "Enintään kaksi. Kolme julkaisua viikossa viidellä alustalla tarkoittaa joka toinen viikko yhtä alustaa — sama kuin ei olisi siellä lainkaan.",
  ...
  "channels.q3": "Kuinka usein pystyt oikeasti julkaisemaan?",
  "channels.q3Why":
    "Rehellinen luku, ei kunnianhimoinen. Suunnitelma jota ei jaksa noudattaa on syy siihen, että edellinen loppui kolmessa viikossa.",
  "channels.q4": "Mitkä ovat sisältöteemasi?",
  "channels.q4Why":
    "Ne kolme tai neljä asiaa, joista tämä brändi puhuu kerta toisensa jälkeen. Nämä tulevat strategiastasi — muokkaa, poista tai lisää omia.",
  "channels.q5": "Ketä yritämme tavoittaa?",
  "channels.q5Why":
    "Brändistrategiasi kohderyhmästä. Lisää ne joita se ei kata — miniprofiili riittää.",
  ...
  "files.upload.noBrand": "Brändiä ei ole valittu, joten tiedostoille ei ole paikkaa. Lataa sivu uudelleen, ja jos se ei auta, tee brändin käyttöönotto ensin.",
  "files.upload.signedOut": "Istuntosi on päättynyt, eikä mitään lähetetty. Kirjaudu uudelleen ja yritä uudestaan — valitsemasi tiedostot ovat yhä tallessa.",
  "files.upload.notYourBrand": "tämän brändin tiedostot kuuluvat toiselle tilille. Kirjaudu sillä tilillä, joka omistaa brändin.",
  ...
  "channels.eyebrow3": "K3 · Kuinka usein",
  "channels.eyebrow4": "K4 · Sisältöteemat",
  "channels.eyebrow5": "K5 · Ihmiset",
  ...
  "channels.maxTwo": "Enintään kaksi — {count} valittu",
  "social.cadence.1": "Kerran viikossa",
  "social.cadence.2to3": "Kaksi tai kolme kertaa viikossa",
  "social.cadence.4to5": "Neljä tai viisi kertaa viikossa",
  "social.cadence.daily": "Joka päivä",
  "social.pillarsFromStrategy": "Ehdotettu brändistrategiastasi",
  "social.addPillar": "Lisää teema",
  "social.pillarName": "Teema, kahdella tai kolmella sanalla",
  "social.pillarWhy": "Miksi tämä brändi voi pitää sitä",
  "social.addSubject": "Lisää aihe",
  "social.subjectPlaceholder": "Aihe josta julkaista",
  "social.noPillarsYet":
    "Ei vielä teemoja. Kirjoita ensin brändistrategia, niin nämä täyttyvät itsestään.",
  "social.audienceFromStrategy": "Brändistrategiastasi",
  "social.addPerson": "Lisää henkilö",
  "social.personName": "Nimi",
  "social.personRole": "Työ tai tilanne",
  "social.personWants": "Mitä he haluavat",
  "social.personWhere": "Missä he jo ovat",
  "social.remove": "Poista",
  "social.needStrategy": "Kirjoita ensin brändistrategiasi",
  "social.needStrategyBody":
    "Tämä suunnitelma rakennetaan asemoinnistasi, äänestäsi ja siellä nimeämistäsi ihmisistä. Vastaa kyselyyn tai lataa olemassa oleva strategiasi ja palaa — siihen menee noin kymmenen minuuttia.",
  "social.toStrategy": "Siirry brändistrategiaan",
  "social.planTitle": "Viikkosi",
  "social.planWhy": "Mitä julkaista, millä kanavalla ja miksi juuri se",
  "social.theMix": "Jakauma",
  "social.regenerate": "Kirjoita eri viikko",
  "social.regenerating": "Kirjoitetaan viikkoasi…",
  "social.copyPost": "Kopioi",
  "social.copied": "Kopioitu",
  "social.hook": "Koukku",
  "social.avoidThisWeek": "Lopeta tämä",
  "social.editAnswers": "Muuta vastauksia",
  "social.generatedOn": "Kirjoitettu {date}",
  "social.planFailed": "Viikkoa ei voitu kirjoittaa. Yritä uudelleen.",
  "social.needChannels": "Valitse ensin vähintään yksi kanava.",
  "social.needPillars": "Lisää ensin vähintään yksi sisältöteema.",
  "social.needWeek": "Tuo viikko ei ole päivämäärä.",
  "social.migrationMissing":
    "Sosiaalisen median taulut puuttuvat. Aja supabase/social-media.sql Supabasen SQL-editorissa.",
  "social.metricsTitle": "Miten viime viikko meni",
  "social.metricsWhy":
    "Kirjoita tähän mitä alustat kertoivat. Seuraavassa vaiheessa haemme nämä ja seuraamme niitä puolestasi — seurattavat luvut eivät muutu kun ne alkavat tulla itsestään.",
  "social.weekOf": "Viikko {date}",
  "social.posts": "Julkaisut",
  "social.followers": "Seuraajat",
  "social.reach": "Kattavuus",
  "social.engagements": "Reaktiot",
  "social.metricsNote": "Mitä luvut eivät kerro",
  "social.saveWeek": "Tallenna tämä viikko",
